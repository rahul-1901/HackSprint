...
import { Users, CheckCircle, XCircle, ArrowLeft, Shield, Images } from 'lucide-react';
...
const HackathonUsersPage = () => {
  ...
  const [activeTab, setActiveTab] = useState('participants'); // 'participants' or 'gallery'
    ...
    <div className="relative min-h-screen bg-gray-900 text-white overflow-hidden">
      ...
      <div className="relative z-10 p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto">
        <header className="my-5">
          ...
          <p className="text-green-400 text-sm font-semibold tracking-wide uppercase">Hackathon Management</p>
