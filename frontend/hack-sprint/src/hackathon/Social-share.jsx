    ...
    <aside className="w-24 min-h-[calc(100vh-88px)] sticky top-[88px]">
      <div className="h-full p-4 flex flex-col items-center gap-6 pt-8 bg-gray-900/50 backdrop-blur-md border-l border-green-500/20">
        ...
        <div className="flex flex-col gap-4 items-center">
          <SocialButton
            hoverColorClass="hover:bg-[#1DA1F2]/20 hover:shadow-[0_0_15px_rgba(29,161,242,0.5)] flex items-center justify-center"
          ...
          <SocialButton
            hoverColorClass="hover:bg-[#1877F2]/20 hover:shadow-[0_0_15px_rgba(24,119,242,0.5)] flex items-center justify-center"
          ...
          <SocialButton
            hoverColorClass="hover:bg-[#0A66C2]/20 hover:shadow-[0_0_15px_rgba(10,102,194,0.5)] flex items-center justify-center"
          ...
          <SocialButton
            hoverColorClass="hover:bg-green-500/20 hover:shadow-[0_0_15px_rgba(34,197,94,0.5)] flex items-center justify-center"
        ...
        <div className="flex flex-col items-center gap-2">
          <SocialButton
            hoverColorClass="hover:bg-red-500/20 flex items-center justify-center hover:shadow-[0_0_15px_rgba(239,68,68,0.5)]"
