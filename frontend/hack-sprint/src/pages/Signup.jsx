...
//       }
//     } catch (err) {
//       const errorMessage = err.response?.data?.message || "Something went wrong, please try later....."
    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-900">
      <div className="text-white shadow-[0_0_25px_#5fff60] p-8 sm:p-10 rounded-xl w-full max-w-md mx-4 backdrop-blur-sm bg-gray-900/80 border border-green-500/20">
        ...
        <div className="space-y-6">
          ...
          <button
            disabled
            className="w-full py-2 rounded-full bg-green-500 opacity-50 cursor-not-allowed text-lg font-medium"
          >
            Signup
          </button>

          <p className="text-xs text-gray-400 text-center">
            Manual signup is currently disabled. Please continue with Google.
          </p>
        </div>
